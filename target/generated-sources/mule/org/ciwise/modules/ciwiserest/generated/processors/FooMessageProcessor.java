...
package org.ciwise.modules.ciwiserest.generated.processors;
...
/**
 * FooMessageProcessor invokes the {@link org.ciwise.modules.ciwiserest.CIWiseRESTConnector#foo()} method in {@link CIWiseRESTConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.8.0", date = "2016-01-10T12:43:11-05:00", comments = "Build UNNAMED.2762.e3b1307")
public class FooMessageProcessor
    extends DevkitBasedMessageProcessor
    implements MessageProcessor, OperationMetaDataEnabled
{


    public FooMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((CIWiseRESTConnector) object).foo();
                    return null;
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at CIWiseRESTConnector at foo retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
